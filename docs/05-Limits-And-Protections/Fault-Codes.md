# ECU-tech OBD fault codes and how to read them

The ECU-tech ECU is providing a number of OBD fault codes,  they are either standard OBD fault codes or ECU-tech custom fault codes.

## ECU-tech specific custom codes are listed below
