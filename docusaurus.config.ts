...
const url = 'https://wiki.ecu.tech';
const isBuild = process.env.NODE_ENV === 'production';
const pdfName = 'wiki.ecu.pdf';
...
const config: Config = {
  ...
  organizationName: 'ECU-tech', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/ECU-tech/wiki/tree/master',
    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          // eg. https://wiki.ecu.tech/r/fuel -> https://wiki.ecu.tech/category/fuel/
          {
            from: '/r/fuel',
            to: '/category/fuel/',
          },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/ECU-tech/wiki',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'ECU-tech.tech',
              href: 'https://www.ecu.tech',
            },
            {
              label: 'GitHub',
              href: 'https://github.com/ECU-tech',
            },
          ],
        },
      ],
      // copyright: `Copyright © ${new Date().getFullYear()} ECU-tech`,
    },
    prism: {
